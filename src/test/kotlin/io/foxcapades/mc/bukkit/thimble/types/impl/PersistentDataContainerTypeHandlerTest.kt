...
import io.foxcapades.mc.bukkit.thimble.types.bukkit.PersistentDataContainerTypeHandler
...
class PersistentDataContainerTypeHandlerTest {
  @Test
  fun deserializerFor() {
    val result = PersistentDataContainerTypeHandler.deserializerFor(1)
      .let {
